...
namespace {
    constexpr uint32_t crcTable[256] = {0x00000000, 0x77073096, 0xEE0E612C, 0x990951BA, 0x076DC419, 0x706AF48F,
    ...
    // TODO 硬件指令优化
    uint32_t AccelerationCRC32(const std::span<const char> data) {return 0;}
}

namespace cabe::util {
    inline uint32_t CRC32(const std::span<const char> data) {
        AccelerationCRC32(std::span<const char>({"\0"}));
